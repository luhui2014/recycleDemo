package com.cnpaypal.BlurEffect;
...
public class BlurEffectMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_blureffect_main);
		...
		if (!blurredImage.exists()) {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					Bitmap newImg = Blur.fastblur(BlurEffectMainActivity.this, image, 12);
		...
		mList.setAdapter(new ArrayAdapter<String>(this, R.layout.list_blur_item, strings));
